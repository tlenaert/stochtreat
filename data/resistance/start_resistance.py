...
def copy_tools(dest):
    ...
    shutil.copy2("./analyze_resistance.py",dest)
...
with cd(folder):
    ...
    for res in res_range:
        parameters= "id="+str(id)+",patients="+str(no_patients)+",output="+str(output)+",treattest="+str(treattest)+",treattime="+str(treattime)+",resistance="+str(res)
        id=id+1
        jobname= parameters
